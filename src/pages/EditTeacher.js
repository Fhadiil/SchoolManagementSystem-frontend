...
const EditTeacher = () => {
  ...
  // Fetch teacher details and options for subjects/classes
  useEffect(() => {
    fetchTeacher();
    fetchSubjects();
    fetchClasses();
  ...
  const fetchTeacher = async () => {
    try {
      const response = await API.get(`/teachers/teachers/${id}/`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await API.put(`/teachers/teachers/${id}/`, updatedTeacher);
      alert("Teacher updated successfully!");
      navigate("/teachers"); // Redirect to the teacher list page
    } catch (error) {
      console.error("Error updating teacher:", error);
      alert("Failed to update teacher. Please check the input and try again.");
    }
  };
